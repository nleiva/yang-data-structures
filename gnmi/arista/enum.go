...
Imported modules were sourced from:
  - ietf
  - arista/EOS-4.30.2F/openconfig/public/release/models
  - arista/EOS-4.30.2F/openconfig/public/release/models/acl
  - arista/EOS-4.30.2F/openconfig/public/release/models/aft
  - arista/EOS-4.30.2F/openconfig/public/release/models/ate
  - arista/EOS-4.30.2F/openconfig/public/release/models/bfd
  - arista/EOS-4.30.2F/openconfig/public/release/models/bgp
  - arista/EOS-4.30.2F/openconfig/public/release/models/catalog
  - arista/EOS-4.30.2F/openconfig/public/release/models/defined-sets
  - arista/EOS-4.30.2F/openconfig/public/release/models/devices-manifest
  - arista/EOS-4.30.2F/openconfig/public/release/models/extensions
  - arista/EOS-4.30.2F/openconfig/public/release/models/firewall
  - arista/EOS-4.30.2F/openconfig/public/release/models/gribi
  - arista/EOS-4.30.2F/openconfig/public/release/models/interfaces
  - arista/EOS-4.30.2F/openconfig/public/release/models/isis
  - arista/EOS-4.30.2F/openconfig/public/release/models/keychain
  - arista/EOS-4.30.2F/openconfig/public/release/models/lacp
  - arista/EOS-4.30.2F/openconfig/public/release/models/lldp
  - arista/EOS-4.30.2F/openconfig/public/release/models/local-routing
  - arista/EOS-4.30.2F/openconfig/public/release/models/macsec
  - arista/EOS-4.30.2F/openconfig/public/release/models/mpls
  - arista/EOS-4.30.2F/openconfig/public/release/models/multicast
  - arista/EOS-4.30.2F/openconfig/public/release/models/network-instance
  - arista/EOS-4.30.2F/openconfig/public/release/models/openflow
  - arista/EOS-4.30.2F/openconfig/public/release/models/optical-transport
  - arista/EOS-4.30.2F/openconfig/public/release/models/ospf
  - arista/EOS-4.30.2F/openconfig/public/release/models/p4rt
  - arista/EOS-4.30.2F/openconfig/public/release/models/pcep
  - arista/EOS-4.30.2F/openconfig/public/release/models/platform
  - arista/EOS-4.30.2F/openconfig/public/release/models/policy
  - arista/EOS-4.30.2F/openconfig/public/release/models/policy-forwarding
  - arista/EOS-4.30.2F/openconfig/public/release/models/probes
  - arista/EOS-4.30.2F/openconfig/public/release/models/qos
  - arista/EOS-4.30.2F/openconfig/public/release/models/relay-agent
  - arista/EOS-4.30.2F/openconfig/public/release/models/rib
  - arista/EOS-4.30.2F/openconfig/public/release/models/sampling
  - arista/EOS-4.30.2F/openconfig/public/release/models/segment-routing
  - arista/EOS-4.30.2F/openconfig/public/release/models/stp
  - arista/EOS-4.30.2F/openconfig/public/release/models/system
  - arista/EOS-4.30.2F/openconfig/public/release/models/telemetry
  - arista/EOS-4.30.2F/openconfig/public/release/models/types
  - arista/EOS-4.30.2F/openconfig/public/release/models/vlan
  - arista/EOS-4.30.2F/openconfig/public/release/models/wifi
*/
package arista
...
// E_Subinterface_AdminStatus is a derived int64 type which is used to represent
// the enumerated node Subinterface_AdminStatus. An additional value named
// Subinterface_AdminStatus_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Subinterface_AdminStatus int64

// IsYANGGoEnum ensures that Subinterface_AdminStatus implements the yang.GoEnum
// interface. This ensures that Subinterface_AdminStatus can be identified as a
// mapped type for a YANG enumeration.
func (E_Subinterface_AdminStatus) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Subinterface_AdminStatus.
func (E_Subinterface_AdminStatus) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Subinterface_AdminStatus.
func (e E_Subinterface_AdminStatus) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Subinterface_AdminStatus")
}

const (
	// Subinterface_AdminStatus_UNSET corresponds to the value UNSET of Subinterface_AdminStatus
	Subinterface_AdminStatus_UNSET E_Subinterface_AdminStatus = 0
	// Subinterface_AdminStatus_UP corresponds to the value UP of Subinterface_AdminStatus
	Subinterface_AdminStatus_UP E_Subinterface_AdminStatus = 1
	// Subinterface_AdminStatus_DOWN corresponds to the value DOWN of Subinterface_AdminStatus
	Subinterface_AdminStatus_DOWN E_Subinterface_AdminStatus = 2
	// Subinterface_AdminStatus_TESTING corresponds to the value TESTING of Subinterface_AdminStatus
	Subinterface_AdminStatus_TESTING E_Subinterface_AdminStatus = 3
)

// E_Subinterface_OperStatus is a derived int64 type which is used to represent
// the enumerated node Subinterface_OperStatus. An additional value named
// Subinterface_OperStatus_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Subinterface_OperStatus int64

// IsYANGGoEnum ensures that Subinterface_OperStatus implements the yang.GoEnum
// interface. This ensures that Subinterface_OperStatus can be identified as a
// mapped type for a YANG enumeration.
func (E_Subinterface_OperStatus) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Subinterface_OperStatus.
func (E_Subinterface_OperStatus) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Subinterface_OperStatus.
func (e E_Subinterface_OperStatus) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Subinterface_OperStatus")
}

const (
	// Subinterface_OperStatus_UNSET corresponds to the value UNSET of Subinterface_OperStatus
	Subinterface_OperStatus_UNSET E_Subinterface_OperStatus = 0
	// Subinterface_OperStatus_UP corresponds to the value UP of Subinterface_OperStatus
	Subinterface_OperStatus_UP E_Subinterface_OperStatus = 2
	// Subinterface_OperStatus_DOWN corresponds to the value DOWN of Subinterface_OperStatus
	Subinterface_OperStatus_DOWN E_Subinterface_OperStatus = 3
	// Subinterface_OperStatus_TESTING corresponds to the value TESTING of Subinterface_OperStatus
	Subinterface_OperStatus_TESTING E_Subinterface_OperStatus = 4
	// Subinterface_OperStatus_UNKNOWN corresponds to the value UNKNOWN of Subinterface_OperStatus
	Subinterface_OperStatus_UNKNOWN E_Subinterface_OperStatus = 5
	// Subinterface_OperStatus_DORMANT corresponds to the value DORMANT of Subinterface_OperStatus
	Subinterface_OperStatus_DORMANT E_Subinterface_OperStatus = 6
	// Subinterface_OperStatus_NOT_PRESENT corresponds to the value NOT_PRESENT of Subinterface_OperStatus
	Subinterface_OperStatus_NOT_PRESENT E_Subinterface_OperStatus = 7
	// Subinterface_OperStatus_LOWER_LAYER_DOWN corresponds to the value LOWER_LAYER_DOWN of Subinterface_OperStatus
	Subinterface_OperStatus_LOWER_LAYER_DOWN E_Subinterface_OperStatus = 8
)
